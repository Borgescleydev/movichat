...
const MIGRATIONS = [
  ...
  // --- Quick Dispatch (Disparo Rápido) ---
  {
    name: "QuickDispatch",
    sql: `CREATE TABLE IF NOT EXISTS "QuickDispatch" (
      "id" TEXT NOT NULL PRIMARY KEY,
      "name" TEXT,
      "instanceId" TEXT NOT NULL,
      "message" TEXT NOT NULL,
  ...
  {
    name: "QuickDispatchRecipient",
    sql: `CREATE TABLE IF NOT EXISTS "QuickDispatchRecipient" (
      "id" TEXT NOT NULL PRIMARY KEY,
  ...
  {
    name: "QuickDispatchRecipient_status_scheduledFor_idx",
    sql: `CREATE INDEX IF NOT EXISTS "QuickDispatchRecipient_status_scheduledFor_idx" ON "QuickDispatchRecipient"("status", "scheduledFor")`,
  },
];
